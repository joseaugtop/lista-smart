...
The keys live in `.claude/settings.json` (project) or `C:/Users/Jose Augusto/Desktop/Unesc/Fase 5/Desenvolvimento Mobile/gsd/.claude/settings.json` (global) — **not** in `.planning/config.json`:
